...
/*
No: utilizada para armazenar valores referentes a cada No no algoritmo A Star
*/
...
/*
    PathMestre: armazeana os Paths produzidos pelo A Star
*/
typedef struct{
    Path *paths;
    int tamanho;
...
void printPontos(Visibilidade *visibilidade); // Printa os pontos necessarios para total visibiliade
